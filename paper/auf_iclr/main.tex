...
Both exports passed frozen-weight and folding checks. Their decoding
validation is pending: completed four-request exactness checks used separate
two-update pilots, not these 100-update checkpoints. No decoding advantage
for either loss is established by these costs.
...
target-token accepted progress. Cross-family results require validation of
the complete decoding path.
