...
from relayspec.native_compute import fit_linear_mlp, fit_pruned_mlp, native_intervention
...
def main():
    ...
    bridges = {}
    if any(m["kind"] in {"linear_mlp", "pruned_mlp"} for m in methods.values()):
        ...
        for i in layer_ids:
            ...
            for fraction, rank in pruning:
                ...
                torch.save(module.state_dict(), args.output/f"pruned-layer{i}-fraction{fraction}-rank{rank}.pt")
