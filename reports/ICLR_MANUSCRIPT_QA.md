...
- Complete PDF: 22 pages including references and appendix
...
| PDF parse and page format | PASS | 22 pages, US Letter, unencrypted, and identity scan clean |
| embedded fonts and PDF parser | PASS | 31 font records are embedded and Ghostscript parses every page |
| recorded visual review | FAIL | manual color and grayscale review covers all 22 rendered pages |
