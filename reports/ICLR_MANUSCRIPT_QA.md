...
- Complete PDF: 34 pages including references and appendix
...
| PDF parse and page format | PASS | 34 pages, US Letter, unencrypted, and identity scan clean |
| embedded fonts and PDF parser | PASS | 34 font records are embedded and Ghostscript parses every page |
| recorded visual review | FAIL | current 34-page PDF lacks a complete matching visual review (recorded 18 pages, matching PDF hash: False) |
