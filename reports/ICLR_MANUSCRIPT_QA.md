...
- Complete PDF: 24 pages including references and appendix
...
| PDF parse and page format | PASS | 24 pages, US Letter, unencrypted, and identity scan clean |
| embedded fonts and PDF parser | PASS | 32 font records are embedded and Ghostscript parses every page |
| recorded visual review | FAIL | manual color and grayscale review covers all 24 rendered pages |
