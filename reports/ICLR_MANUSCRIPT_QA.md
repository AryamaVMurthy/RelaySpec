...
- Complete PDF: 47 pages including references and appendix
...
| PDF parse and page format | PASS | 47 pages, US Letter, unencrypted, and identity scan clean |
| embedded fonts and PDF parser | PASS | 35 font records are embedded and Ghostscript parses every page |
| recorded visual review | PASS | manual color and grayscale review covers all 47 rendered pages |
