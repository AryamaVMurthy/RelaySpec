...
if __name__=='__main__':
    ...
    parser.add_argument('--mode',choices=['ar','native','zip','ce','auf','draft-ce','draft-auf','fusion-ce','fusion-auf','handoff-r56','handoff-five','normal','handoff-ce'],required=True)
