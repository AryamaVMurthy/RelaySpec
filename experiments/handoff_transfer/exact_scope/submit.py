...
def submit(script,name,env,dep=None,gpus=1,array=None):
...
# Cross collection can fill free GPUs, but uses at most two of the four.
data=submit('../cross_data_array.sbatch','b8-cross-data',{},array='0-63%2')
